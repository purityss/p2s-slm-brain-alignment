...
% Define indices for neuron categories
num_pho = 47034;
num_both = 4071;
num_sem = 13232;
...
for k = 1:3
    ...
    % White title used as a vertical spacer
    title(row_titles{k}, 'FontSize', 11, 'Color', 'w'); 
    ...
    title(row_titles{k}, 'FontSize', 11, 'Color', 'w'); % Spacer title
