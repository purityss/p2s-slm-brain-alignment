...
% Results are expected as matrices where Col 1 is neuron count and Col 4 is performance index
...
% Extract Performance values (Performance = 1 - Error Rate in Column 4)
