...
% Layout adjustments
time_spacing = 1.5;  % Distance between time snapshots
x_compression = 0.4; % Horizontal compression for MDS plots
...
% =========================================================================
% Step 2: Procrustes Alignment (Chained, No Scaling)
% =========================================================================
for t = 2:num_time_points
    [~, Y_aligned] = procrustes(Y_storage{t-1}, Y_storage{t}, 'Scaling', false);
...
for t = 1:num_time_points
    for i = 1:num_words
        ...
        if is_special
            ...
            % Special points without black borders
            if strcmp(shape, 'o')
...
% Draw black solid ellipses for boundaries
for t = 1:num_time_points
    center_offset = (t-1) * time_spacing;
