...
save_fig_path = 'G:\Research\01 Speech_Comprehension\02 Figure_AI\Fig_sup_update_202601\Fig4_part';
save_fig_name = 'qwen2_lesion';
...
% 假设已经加载了以下变量:
% pho_lesion, sem_lesion, both_lesion
...
% 图形美化
xlim([0 2000]); yticks(0:500:2000);
% ylim([0.2 1]); yticks(0.2:0.2:1);
% ylim([0.8 1]); yticks(0.8:0.1:1);
ylim([0.6 1]); yticks(0.6:0.1:1);
