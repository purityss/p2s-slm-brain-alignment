...
save_fig_name = 'qwen2_audio_prop_3unit';
...
% --- 绘图 (同时应用 X 和 Y 的转换) ---
% plot(trans_x(layers), trans_y(prop_p),    '-', 'LineWidth', 2, 'Color', color_p);
% plot(trans_x(layers), trans_y(prop_s),    '-', 'LineWidth', 2, 'Color', color_s);
% plot(trans_x(layers), trans_y(prop_both), '-', 'LineWidth', 2, 'Color', color_both);
