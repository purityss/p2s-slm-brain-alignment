...
save_fig_name = 'Combined_Layout_hierarchy_latency';
% save_fig_name = 'Combined_Layout_hierarchy_distance';
...
plot_configs = [
    1, 3; 2, 3; % Row 1  latency 3  distance 6
    1, 5; 2, 5; % Row 2  latency 5   distance 8
    1, 4; 2, 4  % Row 3  latency 4   distance 7
];
