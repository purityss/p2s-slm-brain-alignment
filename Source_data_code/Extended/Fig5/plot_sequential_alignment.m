...
axis_settings = [
    % Row 1: Phonological (Col 6)
    0, 100,  0.8, 1.0;   % Plot 1 (Top Left)
    0, 100,  0.8, 1.0;   % Plot 2 (Top Right)
    
    % Row 2: Semantic (Col 8)
    0, 100,  0.5, 1.5;   % Plot 3 (Middle Left)
    0, 100,  0.5, 1.5;   % Plot 4 (Middle Right)
    
    % Row 3: P2S-transfer (Col 7)
    0, 100, -0.2, 1.0;   % Plot 5 (Bottom Left)
    0, 100, -0.2, 1.0    % Plot 6 (Bottom Right)
];
% =========================================================================
