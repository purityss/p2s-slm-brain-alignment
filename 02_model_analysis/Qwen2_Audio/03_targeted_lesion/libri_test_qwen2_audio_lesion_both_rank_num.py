...
# =========================
# 4) Load lesion sorted neurons (Transfer Score Logic)
# === Read neuron data from .mat file and sort by sum of significance values ===
...
for top_n in list(range(0, 5000, step)):
    ...
    for utt_id, audio_path, ref_text in manifest:
        # Use 16000 sampling rate as required by Qwen
...
# Save as LibriSpeech-specific filename
save_path = os.path.join(save_folder, "qwen2_audio_lesion_rank_results_librispeech_testclean_both.mat")
