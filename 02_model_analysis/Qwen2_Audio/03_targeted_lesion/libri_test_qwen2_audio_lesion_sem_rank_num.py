...
# =========================
# 4) Load lesion sorted neurons (sem_only)
...
# Save as semantic-specific English test result filename
save_path = os.path.join(save_folder, "qwen2_audio_lesion_rank_results_librispeech_testclean_sem.mat")
