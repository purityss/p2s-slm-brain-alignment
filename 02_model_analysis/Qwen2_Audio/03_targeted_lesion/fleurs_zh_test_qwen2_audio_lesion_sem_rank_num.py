...
mat = io.loadmat("qwen2_audio_start_sem_only_neurons.mat")
neuron_data = mat["start_sem_only_neurons"]
...
# save_path = os.path.join(save_folder, "sorted_start_sem_only_neurons.mat")
# io.savemat(save_path,  {"sorted_neurons": sorted_array})
# print("✅ Sorted neuron information has been saved as sorted_start_sem_only_neurons.mat")
...
save_path = os.path.join(save_folder, "qwen2_audio_lesion_rank_results_sem_num.mat")
