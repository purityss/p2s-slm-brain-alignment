...
% Order: Phonological -> Semantic -> Shared
...
% ==========================================
figure(1);
% Increase height to accommodate titles and adjust spacing
...
for k = 1:3
    ...
    % Add title with matching background color (white) just to act as a spacer
    ...
    hold on; % Keep hold on to plot both lines on the same axis
    ...
    % Spacer title to keep alignment with the heatmap
    t_obj2 = title(row_titles{k}, 'FontSize', 11, 'Color', 'w'); 
    
    % Uniform split Y-axis label
